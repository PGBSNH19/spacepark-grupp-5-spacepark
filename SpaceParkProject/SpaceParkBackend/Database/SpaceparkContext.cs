...
namespace SpaceParkBackend.Database
{
    public class SpaceparkContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(new ConfigurationBuilder().AddJsonFile("appsettings.json", true, true).AddJsonFile($"appsettings.Development.json", true, true).Build().GetConnectionString("DefaultConnection"));
        }
